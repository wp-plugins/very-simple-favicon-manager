...
function vsfm_admin_init() {
	add_settings_section( 'vsfm-section', __( 'Favicon (16x16px or multi-size)', 'favicon' ), 'vsfm_section_callback', 'vsfm' );
	...
	add_settings_section( 'vsfm-section-ios', __( 'IOS site icon (180x180px)', 'favicon' ), 'vsfm_section_callback_ios', 'vsfm' );
	add_settings_field( 'vsfm-field-ios', __( 'Your IOS site icon', 'favicon' ), 'vsfm_field_callback_ios', 'vsfm', 'vsfm-section-ios' );
...
<div class="wrap"> 
	...
	<hr>
	<p><?php _e( 'When no favicon or site icon link is added, a default favicon or site icon will be used.', 'favicon' ); ?></p>
	<p><?php _e( 'For more info please check this page: ', 'favicon' ); ?><a href="https://wordpress.org/plugins/very-simple-favicon-manager/faq" target="_blank">VSFM FAQ</a></p>
